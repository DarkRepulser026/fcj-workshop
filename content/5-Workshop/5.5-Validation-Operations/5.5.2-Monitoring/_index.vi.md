...
7. Gửi notification qua SNS topic `sentiment-alerts`.
...
5. Gửi notification qua cùng SNS topic.
...
2. Dùng SNS topic cho thông báo alarm.
3. Giữ widget đơn giản để dashboard dễ đọc trong giai đoạn kiểm tra.

### Kết quả mong đợi

Bạn sẽ mở dashboard và xác nhận stack đang ở trạng thái ổn định trước khi chạy các bước kiểm tra cuối cùng.
