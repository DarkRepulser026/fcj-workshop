...
AWS Lambda — sentiment-analyzer
  (Amazon Comprehend + optional OpenRouter call
   to Meta Llama 3.1 8B Instruct over HTTPS)
      │
      ▼
...
AWS Secrets Manager / SSM Parameter Store ── stores the OpenRouter API key
```
